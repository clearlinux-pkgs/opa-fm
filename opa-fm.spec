...
Version  : 10.12.1.0.6
Release  : 7
URL      : https://github.com/cornelisnetworks/opa-fm/archive/v10.12.1.0.6/opa-fm-10.12.1.0.6.tar.gz
Source0  : https://github.com/cornelisnetworks/opa-fm/archive/v10.12.1.0.6/opa-fm-10.12.1.0.6.tar.gz
...
%prep
%setup -q -n opa-fm-10.12.1.0.6
cd %{_builddir}/opa-fm-10.12.1.0.6
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719356632
...
cp %{_builddir}/opa-fm-%{version}/Esm/ib/doc/cs/COPYING %{buildroot}/usr/share/package-licenses/opa-fm/5868056e5347f049ca07096a4a426c0e4a71a474 || :
cp %{_builddir}/opa-fm-%{version}/Esm/ib/test/cs/COPYING %{buildroot}/usr/share/package-licenses/opa-fm/492fce15e8c89e8038b4f09f98c86aa1212f5651 || :
cp %{_builddir}/opa-fm-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/opa-fm/948af859e51811abec8ee00c3a27db28934270cf || :
export GOAMD64=v2
GOAMD64=v2
%make_install ||:
